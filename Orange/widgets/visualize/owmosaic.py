...
class OWMosaicDisplay(OWWidget, VizRankMixin(MosaicVizRank)):
    ...
    def update_graph(self):
        ...
        # Cache prior distribution once — reused inside draw_data() for every rectangle
        prior_distribution = get_distribution(data, class_var.name) \
            if class_var else None
        # TODO: check this
